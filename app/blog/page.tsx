...
<main  className="bg-white text-black">
    ...
    <section className=" pt-20 pb-10 pr-10 pl-10  w-full h-auto grid grid-cols-1 item-center sm:grid-cols-3 gap-8 text-black">
...
<p className="w-full pl-3 pt-5">Ifeanyi Micheal</p>
          <p className="max-w-[400px] pl-3 pt-5">DonoH as a Digital platform was 
          developed to
...
of providing or receiving this aid.</p>
        ...
        <Image 
          ...
          <p className="max-w-[400px] pl-3 pt-5">DonoH as a Digital platform was developed to
connect patients with kind hearted individuals/
Organizations but has no connection with the
general public who sign up for the sole purpose
of providing or receiving this aid.</p>
